...
class JFormFieldAcetheme extends JFormFieldList
{
    ...
    public function getInput()
    {
        ...
        $a = '  <a style="float: left; margin-left: 10px;" class="akmarkdown-help-button btn btn-small delicious light green-pastel" href="https://github.com/ajaxorg/ace/tree/master/lib/ace/theme" target="_blank">'.JText::_('JHELP').'</a>' ;
